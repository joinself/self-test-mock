...
pub mod hashgraph {
    ...
    impl<'a> Embedded<'a> {
        ...
        #[inline]
        pub fn controller(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
    ...
    impl core::fmt::Debug for Embedded<'_> {
    ...
    impl core::fmt::Debug for Reference<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    impl<'a> Action<'a> {
        ...
        pub fn roles(&self) -> u64 {
            ...
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe { self._tab.get::<u64>(Action::VT_ROLES, Some(0)).unwrap() }
        }
        #[inline]
        ...
        pub fn description_as_reference(&self) -> Option<Reference<'a>> {
            if self.description_type() == Description::Reference {
                self.description().map(|t| {
                    ...
                    // Created from a valid Table for this object
                    // Which contains a valid union in this slot
                    unsafe { Reference::init_from_table(t) }
                })
            } else {
                None
            }
    ...
    impl<'a> Operation<'a> {
        ...
        #[inline]
        pub fn previous(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
    ...
    impl<'a> SignedOperation<'a> {
        ...
        #[inline]
        pub fn operation(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
