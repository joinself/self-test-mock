...
pub mod siggraph {
    ...
    impl core::fmt::Debug for KeyAlgorithm {
    ...
    pub const ENUM_MAX_KEY_ROLE: u8 = 2;
    #[deprecated(
        since = "2.0.0",
        note = "Use associated constants instead. This will no longer be generated in 2021."
    )]
    #[allow(non_camel_case_types)]
    pub const ENUM_VALUES_KEY_ROLE: [KeyRole; 3] =
        [KeyRole::Identifier, KeyRole::Signing, KeyRole::Recovery];
    ...
    #[allow(non_upper_case_globals)]
    impl KeyRole {
        pub const Identifier: Self = Self(0);
        pub const Signing: Self = Self(1);
        pub const Recovery: Self = Self(2);

        pub const ENUM_MIN: u8 = 0;
        pub const ENUM_MAX: u8 = 2;
        pub const ENUM_VALUES: &'static [Self] = &[Self::Identifier, Self::Signing, Self::Recovery];
        /// Returns the variant's name or "" if unknown.
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
    ...
    impl core::fmt::Debug for KeyRole {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            if let Some(name) = self.variant_name() {
                f.write_str(name)
            } else {
    ...
    impl core::fmt::Debug for Actionable {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            if let Some(name) = self.variant_name() {
                f.write_str(name)
            } else {
    ...
    impl<'a> CreateKey<'a> {
        ...
        pub fn role(&self) -> KeyRole {
            self._tab
                .get::<KeyRole>(CreateKey::VT_ROLE, Some(KeyRole::Identifier))
                .unwrap()
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> CreateKeyBuilder<'a, 'b> {
        ...
        pub fn add_role(&mut self, role: KeyRole) {
            self.fbb_
                .push_slot::<KeyRole>(CreateKey::VT_ROLE, role, KeyRole::Identifier);
        }
        #[inline]
    ...
    impl core::fmt::Debug for CreateKey<'_> {
    ...
    impl core::fmt::Debug for RevokeKey<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    impl core::fmt::Debug for Recover<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    impl core::fmt::Debug for SignatureHeader<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    impl core::fmt::Debug for SignedOperation<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
