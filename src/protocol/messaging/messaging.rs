...
pub mod messaging {
    ...
    impl<'a> MlsCommit<'a> {
        ...
        #[inline]
        pub fn commit(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
    ...
    impl core::fmt::Debug for MlsCommit<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    impl<'a> MlsWelcome<'a> {
        ...
        #[inline]
        pub fn welcome(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
        ...
        #[inline]
        pub fn send(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
        ...
        #[inline]
        pub fn subscription(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
    ...
    impl core::fmt::Debug for MlsWelcome<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    impl<'a> MlsKeyPackage<'a> {
        ...
        #[inline]
        pub fn package(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
        ...
        #[inline]
        pub fn push_(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
    ...
    impl core::fmt::Debug for MlsKeyPackage<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    impl core::fmt::Debug for MlsMessage<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    impl<'a> MlsProposal<'a> {
        ...
        #[inline]
        pub fn proposal(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
    ...
    impl core::fmt::Debug for MlsProposal<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    impl<'a> Open<'a> {
        ...
        pub fn nonce(&self) -> u64 {
            ...
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe { self._tab.get::<u64>(Open::VT_NONCE, Some(0)).unwrap() }
        }
        #[inline]
